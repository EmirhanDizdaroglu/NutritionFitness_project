                    ...
                    <tbody>
                        {movements.map(movement => (
                            <tr key={movement._id}>
                                ...
                                <td>
                                    <button onClick={() => handleEdit(movement)} style={{ ...buttonStyle, backgroundColor: '#FFC107' }}>Edit</button>
                                    <button onClick={() => handleDelete(movement._id)} style={{ ...buttonStyle, backgroundColor: '#DC3545' }}>Delete</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
